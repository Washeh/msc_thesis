...
# based on https://github.com/openai/baselines/blob/master/baselines/a2c/policies.py
...
def train(env_id, policy_fn, num_timesteps, seed, lrschedule, num_cpu):
    def make_env(rank):
        def _thunk():
...
def main():
    ...
    policy = PolicyWrapper('./../saves/baselines/a2c/test/', LstmPolicy)
    train(args.env, policy, num_timesteps=args.num_timesteps, seed=args.seed, lrschedule=args.lrschedule, num_cpu=8)
    policy.save()
